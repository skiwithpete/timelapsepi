...
system('gst-launch-1.0 multifilesrc location=/home/pi/timelapse/image%04d.jpg index=0 caps="image/jpeg,framerate=24/1" ! jpegdec ! omxh264enc ! avimux ! filesink location=/home/pi/timelapse/`date +%Y%m%d%H%M`timelapse.avi')
